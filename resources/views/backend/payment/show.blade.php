        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{ url('admin/payment') }}" class="pull-right"><span class="glyphicon glyphicon-chevron-left">Back</span></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <table class="col-lg-12 col-md-12 col-sm-12 table">
              <div class="body">
                ...
                @if(!empty($payment))
                <tr><td class="col-md-6"><strong> First Name</strong></td><td class="col-md-6">{{ $payment['first_name'] }}</td><td></td><td></td></tr>
                <tr><td class="col-md-6"><strong> Last Name</strong></td><td class="col-md-6">{{ $payment['last_name'] }}</td><td></td><td></td></tr>
